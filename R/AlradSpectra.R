...
AlradSpectra <- function() {
  ...
  tryCatch(
    ...
    ann.test     <- caret::train(form.mdl, data = Train, method = 'elm', trControl = bootControl, tuneGrid =Grid)
  ...
  kbml.model    <<- kernlab::gausspr(form.mdl, data=Train, kernel= "vanilladot", type = "regression", kpar="vanilladot",
